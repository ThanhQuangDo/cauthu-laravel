...
@method('PUT')
    ...
    <div class="form-group">
        ...
        <input type="text" value="{{$blog->title}}" name="title" class="form-control" id="exampleInputtt" aria-describedby="emailHelp" >
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <textarea id="demo" name="content" class="form-control" rows="8" style="resize:none">{{$blog->content}}</textarea>
    </div>
