                ...
                <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        @foreach($danhmuctruyen as $key => $danhmuc)
                            <tr>
                                <th scope="row">{{$danhmuc->danhmuc_id}}
                                    ...
                                    <td>
                                        <a href="{{route('danhmuc.edit', [$danhmuc->danhmuc_id])}}" class="btn btn-primary">Chỉnh sửa</a>
                                    </td>
                                    <td>
                                        <form action="{{route('danhmuc.destroy', [$danhmuc->danhmuc_id])}}">
                                        @method('DELETE')
                                        @csrf
